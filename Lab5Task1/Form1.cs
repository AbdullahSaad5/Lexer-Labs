        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < finalArray.Count; i++)
            {
                    ...
                    else if (variables.Success)
                    {
                        ...
                        if (!keywordList.Contains(finalArrayc[x].ToString())) // if it is not a keyword
                        {
                            ...
                            if (category1.Success)
                            {
                                ...
                                hashtable.Add(row, finalArrayc[x] + " " + finalArrayc[x - 1] + " " +
                       finalArrayc[x + 2] + " " + line_num);
                ...
                /*                tfToken.AppendText(SymbolTable[row, 1].ToString() + " \t ");
                                ...
                                tfToken.AppendText(row.ToString() + " \t ");
                                tfToken.AppendText(finalArrayc[x].ToString() + " \t ");
                                tfToken.AppendText(finalArrayc[x - 1].ToString() + " \t ");
                                tfToken.AppendText(finalArrayc[x + 2].ToString() + " \t ");
                                tfToken.AppendText(line_num.ToString() + " \n ");
                                row++;
                                count++;
                            }
